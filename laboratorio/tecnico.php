...
require_once 'models/tbTecnico.php';
?>
<!doctype html>
<html lang="en">
...
<body>
    ...
    <main>
        ...
        <div class="album py-5 bg-light">
            <div class="container">
                <h1 class="fw-light">Confira os nossos técnicos conveniados</h1>
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php foreach ($tbTecnico as $tecnico) { ?>
                            <tr>
                                <td><?php echo $tecnico['co_matricula']; ?></td>
                                <td><?php echo $tecnico['no_funcionario']; ?></td>
                                <td><?php echo $tecnico['nu_cpf']; ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
