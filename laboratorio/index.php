<?php
    ...
    require_once 'models/tbTipoExame.php';
?>
<!doctype html>
<html lang="en">
  <head>
...
<main>
  ...
  <div class="album py-5 bg-light">
    <div class="container">
    <h1 class="fw-light">Confira os exames que realizamos</h1>
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <?php foreach($tbTipoExame as $exame) : ?>
        <div class="col">
          <div class="card shadow-sm">
            <div class="card-body">
            <img class="d-block mx-auto mb-4" src="https://loja.sabin.com.br/skin/frontend/new-theme/default/images/home_call_highlight_1.png" alt="" width="72" height="57">
              <h3><?=$exame['no_tipo_exame']; ?></h3>
              <p class="card-text"><?=$exame['no_metodo']; ?></p>
              <p class="card-text"><?=$exame['no_material']; ?></p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary">Saiba mais</button>
                </div>
                <small class="text-muted">R$ <?=$exame['vl_preco']; ?></small>
              </div>
            </div>
          </div>
        </div>
